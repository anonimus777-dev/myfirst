"""Центральная маршрутизация текстовых сообщений и callback-кнопок.

Перенесено из исходного монолита. После выноса импортов станет единой точкой маршрутизации.
"""
